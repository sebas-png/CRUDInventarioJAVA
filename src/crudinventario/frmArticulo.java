...
// TODO add your handling code here:
    ...
    try {
        ...
        try{
           Image logo = Image.getInstance("televix logo.jpg");
    ...
    private void JMIReporteBonitoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JMIReporteBonitoActionPerformed
        ...
        try {
    // IMPORTANTE: Asegúrate que el nombre "Reporte_Inventario.pdf" 
    // sea el mismo que pusiste en el FileOutputStream de abajo.
    File archivoPdf = new File("Reporte_Inventario.pdf"); 
    if (archivoPdf.exists()) {
        java.awt.Desktop.getDesktop().open(archivoPdf);
    } else {
        javax.swing.JOptionPane.showMessageDialog(this, "El archivo no se encontró en la carpeta.");
    }
} catch (Exception ex) {
